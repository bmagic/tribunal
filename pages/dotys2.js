          ...
          <div className="container">
            <div className="columns">
              <div className="column is-6 is-offset-6">
                ...
                <a href="https://youtu.be/JDlrvNjfE2k?t=385" rel="noreferrer" target='_blank' className="button is-white is-inverted">Regarder la catégorie&ensp;<FontAwesomeIcon icon={faChevronRight} /></a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="container">
            <div className="columns">
              <div className="column is-6">
                ...
                <hr className="content-divider" />
                <a href="https://youtu.be/JDlrvNjfE2k?t=2489" rel="noreferrer" target='_blank' className="button is-white is-inverted">Regarder la catégorie&ensp;<FontAwesomeIcon icon={faChevronRight} /></a>
              </div>
            </div>
          </div>
        </div>
