...
export default function Home() {
  return (
    <main className="doty">
          ...
          <div className="container">
            <div className="level">
              <div className="level-item">
                <a
                  href="#animaux"
                  className="button is-white is-medium is-inverted"
                >
                  Animaux&ensp;
              ...
              <div className="level-item">
                <a
                  href="#miniminimaliste"
                  className="button is-white is-medium is-inverted"
                >
                  Miniminimaliste&ensp;
                  <FontAwesomeIcon icon={faChevronRight} />
                </a>
              </div>
              <div className="level-item">
                <a
                  href="#bricolobordelique"
                  className="button is-white is-medium is-inverted"
                >
                  Bricolo bordélique&ensp;
                  <FontAwesomeIcon icon={faChevronRight} />
                </a>
              </div>
              <div className="level-item">
              ...
              <div className="level-item">
                <a
                  href="#prixspecialdupublic"
                  className="button is-white is-medium is-inverted"
                >
                  Prix spécial du public&ensp;
                  <FontAwesomeIcon icon={faChevronRight} />
                </a>
              </div>
              <div className="level-item">
      ...
      <section
        className="parallax hero is-fullheight "
        style={{
          ...
          <div className="container">
            <div className="columns">
              <div className="column is-6 is-offset-6">
                ...
                <a
                  href="https://youtu.be/aMlUdUnFLTM?t=385"
                  rel="noreferrer"
                  target="_blank"
                  className="button is-white is-inverted"
                >
                  Regarder la catégorie&ensp;
                  <FontAwesomeIcon icon={faChevronRight} />
                </a>
              </div>
            </div>
          ...
          <div className="container">
            <div className="columns">
              <div className="column is-6">
                ...
                <hr className="content-divider" />
                <a
                  href="https://youtu.be/aMlUdUnFLTM?t=1516"
                  rel="noreferrer"
                  target="_blank"
                  className="button is-white is-inverted"
                >
          ...
          <div className="container">
            <div className="columns">
              <div className="column is-6 is-offset-6">
                ...
                <hr className="content-divider" />
                <a
                  href="https://youtu.be/aMlUdUnFLTM?t=2810"
                  rel="noreferrer"
                  target="_blank"
                  className="button is-white is-inverted"
                >
          ...
          <div className="container">
            <div className="columns">
              <div className="column is-6">
                ...
                <hr className="content-divider" />
                <a
                  href="https://youtu.be/aMlUdUnFLTM?t=4120"
                  rel="noreferrer"
                  target="_blank"
                  className="button is-white is-inverted"
                >
          ...
          <div className="container">
            <div className="columns">
              <div className="column is-6 is-offset-6">
                ...
                <hr className="content-divider" />
                <a
                  href="https://youtu.be/aMlUdUnFLTM?t=6136"
                  rel="noreferrer"
                  target="_blank"
                  className="button is-white is-inverted"
                >
          ...
          <div className="container">
            <div className="columns">
              <div className="column is-6">
                ...
                <hr className="content-divider" />
                <a
                  href="https://youtu.be/aMlUdUnFLTM?t=7049"
                  rel="noreferrer"
                  target="_blank"
                  className="button is-white is-inverted"
                >
